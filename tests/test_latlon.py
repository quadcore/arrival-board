...
class TestGetBoundingSquareFromPoint:
    ...
    @pytest.mark.parametrize("coord,expected", [
        (Coord(41.977000, 87.908167), Bbox(Coord(42.079252, 87.77029), Coord(41.874583, 88.045601))),
        (Coord(41.977000, -87.908167), Bbox(Coord(42.079252, -88.046044), Coord(41.874583, -87.770733))),
        (Coord(-41.977000, 87.908167), Bbox(Coord(-41.874583, 87.770733), Coord(-42.079252, 88.046044))),
        (Coord(-41.977000, -87.908167), Bbox(Coord(-41.874583, -88.045601), Coord(-42.079252, -87.77029))),
        (Coord(0, 87.908167), Bbox(Coord(0.102334, 87.805832), Coord(-0.102334, 88.010502))),
        (Coord(41.977000, 0), Bbox(Coord(42.079252, -0.137877), Coord(41.874583, 0.137434))),
        (Coord(0, 0), Bbox(Coord(0.102334, -0.102335), Coord(-0.102334, 0.102335))),
    ])
    def test_lat_lon_input(self, coord, expected):
        box: Bbox = latlon.get_bounding_square_from_point(coord=coord, radius_miles=10)
        assert box == expected

    @pytest.mark.parametrize("radius_miles,expected", [
        (10, Bbox(Coord(42.079252, -88.046044), Coord(41.874583, -87.770733))),
        (.1, Bbox(Coord(41.978023, -87.909544), Coord(41.975977, -87.90679))),
        (0, Bbox(Coord(41.977000, -87.908167), Coord(41.977000, -87.908167))),
        (-10, Bbox(Coord(41.874583, -87.770733), Coord(42.079252, -88.046044))),
    ])
    def test_radius_miles_input(self, radius_miles, expected):
        box: Bbox = \
            latlon.get_bounding_square_from_point(coord=Coord(41.977000, -87.908167),
